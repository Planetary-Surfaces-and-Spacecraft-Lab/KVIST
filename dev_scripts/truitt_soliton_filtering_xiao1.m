...
% Xiao 1 test case 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
U = readmatrix('truitt_data/xiao1/U_xiao1.txt');
xz= readmatrix('truitt_data/xiao1/xz_xiao1.txt');
tz = readmatrix('truitt_data/xiao1/tz_xiao1.txt');
