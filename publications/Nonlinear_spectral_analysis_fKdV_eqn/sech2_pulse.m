...
figure;imagesc(xz,tz,full_solution);xlim([-5 15]);
...
ax = gca;
ax.LineWidth = 3;
saveas(gcf,'figures/homo_sech2_signal.eps','epsc')
saveas(gcf,'figures/homo_sech2_signal.png')
...
set(gca, 'FontName', 'Helvetica');
saveas(gcf,'figures/homo_sech2_fft.eps','epsc')
saveas(gcf,'figures/homo_sech2_fft.png')
...
yyaxis right;
plot(k_ist(1,:), m{1},'^');
plot(k_ist(100,:), m{100},'>');
plot(k_ist(200,:), m{200},'<');
...
set(gca, 'FontName', 'Helvetica');
saveas(gcf,'figures/homo_sech2_ist.eps','epsc')
saveas(gcf,'figures/homo_sech2_ist.png')
...
xlim(xlim_n)
ylim(ylim_n)
saveas(gcf,'figures/homo_sech2_ist_process.eps','epsc')
saveas(gcf,'figures/homo_sech2_ist_process.png')
