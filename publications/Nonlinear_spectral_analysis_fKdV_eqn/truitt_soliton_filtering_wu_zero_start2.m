...
%% Ploting
% .mat file for above analysis: truitt_data/wu_zero_start/ist_analysis2.mat
...
xlabel('x');
grid on;
saveas(gcf,'figures/wu_zero_start_signal2_no_ylabel.eps','epsc')
saveas(gcf,'figures/wu_zero_start_signal2_no_ylabel.png');
ylabel('u(x)');
saveas(gcf,'figures/wu_zero_start_signal2.eps','epsc')
saveas(gcf,'figures/wu_zero_start_signal2.png')
...
saveas(gcf,'figures/wu_zero_start_decomp2.eps','epsc')
saveas(gcf,'figures/wu_zero_start_decomp2.png')
...
set(gca, 'FontName', 'Helvetica');
saveas(gcf,'figures/wu_zero_start_ist2.eps','epsc')
saveas(gcf,'figures/wu_zero_start_ist2.png')
