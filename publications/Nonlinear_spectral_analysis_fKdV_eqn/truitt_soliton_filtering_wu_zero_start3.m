...
xlabel('x');
grid on;
saveas(gcf,'figures/wu_zero_start_signal3_no_ylabel.eps','epsc')
saveas(gcf,'figures/wu_zero_start_signal3_no_ylabel.png');
ylabel('u(x)');
saveas(gcf,'figures/wu_zero_start_signal3.eps','epsc')
saveas(gcf,'figures/wu_zero_start_signal3.png')
...
saveas(gcf,'figures/wu_zero_start_decomp3.eps','epsc')
saveas(gcf,'figures/wu_zero_start_decomp3.png')
...
set(gca, 'FontName', 'Helvetica');
saveas(gcf,'figures/wu_zero_start_ist3.eps','epsc')
saveas(gcf,'figures/wu_zero_start_ist3.png')
