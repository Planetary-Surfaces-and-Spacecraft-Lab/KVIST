...
saveas(gcf,'figures/debris_forcing_sim.eps','epsc')
saveas(gcf,'figures/debris_forcing_sim.png')
...
for i = 1:length(tz_PIST_idx)
    ...
    set(gca, 'FontName', 'Helvetica');
    saveas(gcf,sprintf('figures/debris_forcing_ist%i.eps',i),'epsc')
    saveas(gcf,sprintf('figures/debris_forcing_ist%i.png',i))
end
