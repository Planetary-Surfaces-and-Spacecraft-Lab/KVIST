...
beta = -1/6;
lambda = alpha/(6*beta);
signal = real(U(800:1250,20))';
signal = signal;%+randn(1,length(signal))*max(signal);
xz_original = xz;
xz = xz(800:1250);
...
%% Ploting
% .mat file for above analysis: truitt_data/wu_zero_start/ist_analysis1.mat
...
xlabel('x');
grid on;
saveas(gcf,'figures/wu_zero_start_signal1_no_ylabel.eps','epsc')
saveas(gcf,'figures/wu_zero_start_signal1_no_ylabel.png')
ylabel('u(x)');
saveas(gcf,'figures/wu_zero_start_signal1.eps','epsc')
saveas(gcf,'figures/wu_zero_start_signal1.png')
...
saveas(gcf,'figures/wu_zero_start_decomp1.eps','epsc')
saveas(gcf,'figures/wu_zero_start_decomp1.png')
...
set(gca, 'FontName', 'Helvetica');
saveas(gcf,'figures/wu_zero_start_ist1.eps','epsc')
saveas(gcf,'figures/wu_zero_start_ist1.png')
