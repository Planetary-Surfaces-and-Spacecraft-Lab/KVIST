...
%% Ploting
% .mat file for above analysis: truitt_data/wu_zero_start/ist_analysis5.mat
...
xline(tz(90),'b','linewidth',lwl);
xline(tz(40),'b','linewidth',lwl);
xline(tz(100),'b','linewidth',lwl);
ylim([xz(1) xz(end)]);
...
xlabel('x');
grid on;
saveas(gcf,'figures/wu_zero_start_signal5_no_ylabel.eps','epsc')
saveas(gcf,'figures/wu_zero_start_signal5_no_ylabel.png')
ylabel('u(x)');
saveas(gcf,'figures/wu_zero_start_signal5.eps','epsc')
saveas(gcf,'figures/wu_zero_start_signal5.png')
...
saveas(gcf,'figures/wu_zero_start_decomp5.eps','epsc')
saveas(gcf,'figures/wu_zero_start_decomp5.png')
...
set(gca, 'FontName', 'Helvetica');
saveas(gcf,'figures/wu_zero_start_ist5.eps','epsc')
saveas(gcf,'figures/wu_zero_start_ist5.png')
